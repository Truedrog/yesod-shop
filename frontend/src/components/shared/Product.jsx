                ...
                <div className="product__content">
                    ...
                    <div className="product__info">
                        ...
                        <ul className="product__features">
                            {product.features.map((feature, index) => <li
                                key={index}>{`${feature.featureName}: ${feature.value}`}</li>)}
                        </ul>
                    ...
                    <div className="product__sidebar">
                        ...
                        {/*<form className="product__options"> todo product options*/}
                    ...
                    {/*                It</Link></li>*/}
                    {/*            <li className="share-links__item share-links__item--type--counter"><Link*/}
                    {/*                to="/">4K</Link></li>*/}
                    {/*        </ul>*/}
                    {/*    </div>*/}
                    {/*</div>*/}
